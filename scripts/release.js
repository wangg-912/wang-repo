...
const runIfNotDry = isDryRun ? dryRun : run
    ...
    ; (async function main() {
        ...
        step('\nRunning wang tests...')
        await run('yarn', ['workspace', 'wang', 'test'])

        step('\nBuilding components...')
        await run('yarn', ['workspace', 'wang', 'build'])
        ...
        step('\nUpdating wang cross dependencies...')
        ...
        await runIfNotDry(
            ...
            {
                cwd: path.resolve(__dirname, '../packages/components'),
                stdio: 'pipe'
            }
        )
